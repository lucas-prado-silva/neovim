...
require "lucas.lsp-config.lsp-saga-config"
...
remap("n", "<leader>ll", ":lua vim.lsp.buf.hover()<CR>", lsp_opts)
...
remap("n", "<leader>sld", "<cmd>Lspsaga show_line_diagnostics<cr>", lsp_opts)
